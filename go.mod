module github.com/LHYi/rc-contract-go

go 1.17

require (
	github.com/LHYi/rc-contract-go/response-credit v0.0.0-20220123092114-6543338dc931
	github.com/hyperledger/fabric-contract-api-go v1.1.1
)

require (
	github.com/LHYi/rc-contract-go/ledger-api v0.0.0-20220123091825-b0a228389320 // indirect
